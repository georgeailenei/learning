...
class movieValidator:
    ...
    def validator(self, movie):
        ...
        return self.checkGenre(movie.genre) and self.checkDescriptionLength(movie.description) and self.checkTittle(movie.title)


class clientValidator(movieValidator):
    ...
    def validator(self, Client):
        ...
        return self.checkCnpLength(Client.CNP) and self.checkCnpInt(Client.CNP) and self.checkTittle(Client.name)
